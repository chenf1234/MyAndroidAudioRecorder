...
public class MainActivity extends AppCompatActivity {
    ...
    private RadioGroup rgSampleRate;
    private Button rg48k;
    private Button rg44k;
    //需要申请的运行时权限
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rg48k=(Button)findViewById(R.id.rg48k);
        rg44k=(Button)findViewById(R.id.rg44k);
        rgSampleRate=(RadioGroup)findViewById(R.id.rgSampleRate);
        rgSampleRate.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId){
                    case R.id.rg44k:{
                        audiorecord.changeSampleRate(44100);
                        break;
                    }
                    case R.id.rg48k:{
                        audiorecord.changeSampleRate(48000);
                        break;
                    }
                    default:break;
                }
    ...
    public void start(View view){
        ...
        if(state==0){//开始录音
            ...
            Log.d("MainActivity-start","重新开始录音。。。。。。。。");
            audiorecord.start();
        ...
        myalert.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (input.equals("")) {
                        ...
                        Log.d("MainActivity","保存文件名："+input+".wav");
                        //转换，必须写在dialog内部！
    ...
    public void stop(View view){
        Log.d("MainActivity-stop","停止录音。。。。。。。。");
        //首先停止录音
        audiorecord.stop();
        rg48k.setEnabled(true);
        rg44k.setEnabled(true);
        WavListButton.setEnabled(true);
